...
const PostItem = ({
    ...
    if (post.title !== ""){
      ...
      <>
           <div className="col-1">
           <img className="wd-small-image" src={post.avatarIcon}/>
</div>
           <div className="col-11 ps-4">
            ...
            <div className="row mt-1">
                <div className="wd-image ">
                    <img src={post.image} className="img-fluid wd-home-image"/>
                </div>
            </div>
            <div className="row mb-2 g-0 px-2 py-2 wd-home-text">
             ...
             <div className="row">
                 <div className="wd-dark-font col-12 d-flex justify-content-between">
                    <a className=" wd-stats wd-icon" href="#"><i className="far fa-comment wd-icon wd-icon-set pe-3"></i><span
                            className="wd-icon-set">{post.comments}</span></a>
                    <a className=" wd-stats wd-icon" href="#" ><i className=" fas fa-retweet wd-icon wd-icon-set pe-3"></i><span
                            className="wd-icon-set">{post.retweets}</span></a>
                    <a className=" wd-stats wd-icon" href="#"><i className="far fa-heart wd-icon wd-icon-set pe-3"></i><span
                            className="wd-icon-set">{post.likes}</span></a>
                    <a className=" wd-stats wd-icon" href="#"><i className="fas fa-external-link-alt wd-icon wd-icon-set pe-5"></i></a>
                </div>
              </div>
            </div>
        ...
        <>
           ...
           <div className="col-11 ps-4">
            ...
            <div className="row mt-1 mb-2">
                <div className="wd-image">
                    <img src={post.image} className="img-fluid wd-home-image-alt"/>
                </div>
            </div>
             ...
             <div className="row">
                 <div className="wd-dark-font col-12 d-flex justify-content-between">
                    <a className="wd-stats wd-icon" href="#"><i className="pe-3 far fa-comment wd-icon wd-icon-set"></i><span
                            className="wd-icon-set">{post.comments}</span></a>
                    <a className="wd-stats wd-icon" href="#" ><i className="pe-3 fas fa-retweet wd-icon wd-icon-set"></i><span
                            className="wd-icon-set">{post.retweets}</span></a>
                    <a className="wd-stats wd-icon" href="#"><i className="pe-3 far fa-heart wd-icon wd-icon-set"></i><span
                            className="wd-icon-set">{post.likes}</span></a>
                    <a className="wd-stats wd-icon" href="#"><i className="fas fa-external-link-alt wd-icon wd-icon-set pe-5"></i></a>
                </div>
              </div>
