            ...
            <table>
                <tr>
                    <td className="align-text-top">
                        <img className="rounded-circle wd-avatar-image" alt=""
                             src={tweet['logo-image']}/>
                    </td>
                    <td className="ps-3" style={{width: '100%'}}>
                        <i onClick={deleteTweetClickHandler} className="fa fas fa-times fa-remove fa-pull-right"></i>
                        ...
                        </div>
                        {
                            ...
                            <img src={tweet.attachments.image} alt=""
